...
__global__ void reduction_first_add(const float* __restrict__ g_in,
...
int main(void)
{
    ...
    for (int i = 0; i < WARMUP; i++)
        reduction_first_add<<<GRID, BLOCK, BLOCK*sizeof(float)>>>(d_in, d_out, N);
    ...
    printf("=== reduction_first_add (Harris reduce6) ===\n");
